...
def animal_inference():
    ...
    # Load trained-model
    model_PATH = 'detection\\trained_weights\\cnn_animals.pth'
    model = ConvNet().to(device)
    model.load_state_dict(torch.load(model_PATH))
    # print(model.eval())

    # load in image
    image = Image.open('detection\\images\\downsample_animal.png')
